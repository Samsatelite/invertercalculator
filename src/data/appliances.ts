...
export const allowedCombinations: [string, string][] = [
  ...
  ['mini_fridge', 'air_conditioner'],
  ['mini_fridge', 'ac_1hp'],
  ['mini_fridge', 'ac_1hp_inv'],
  ['mini_fridge', 'ac_15hp'],
  ['mini_fridge', 'ac_15hp_inv'],
  ['mini_fridge', 'ac_2hp'],
  ['mini_fridge', 'ac_2hp_inv'],
  ['top_bottom_freezer', 'air_conditioner'],
  ['top_bottom_freezer', 'ac_1hp'],
  ['top_bottom_freezer', 'ac_1hp_inv'],
  ['top_bottom_freezer', 'ac_15hp'],
  ['top_bottom_freezer', 'ac_15hp_inv'],
  ['top_bottom_freezer', 'ac_2hp'],
  ['top_bottom_freezer', 'ac_2hp_inv'],
  ['deep_freezer', 'air_conditioner'],
  ['deep_freezer', 'ac_1hp'],
  ['deep_freezer', 'ac_1hp_inv'],
  ['deep_freezer', 'ac_15hp'],
  ['deep_freezer', 'ac_15hp_inv'],
  ['deep_freezer', 'ac_2hp'],
  ['deep_freezer', 'ac_2hp_inv'],
